package com.github.bfabri.armoreffects.commands.utils.framework;
...
public class SimpleCommandManager implements CommandManager {
    ...
    public SimpleCommandManager(ArmorEffects plugin) {
            ...
            public void run() {
                ...
                for (BaseCommand command : commands) {
                    ...
                    if (pluginCommand == null) {
                        ...
                        pluginCommand.setPermission("armoreffect.command." + command.getName());
